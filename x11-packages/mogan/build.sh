...
TERMUX_PKG_DEPENDS="freetype, ghostscript, libandroid-execinfo, libandroid-wordexp, libc++, libcurl, libgit2, libiconv, libjpeg-turbo, libpng, qt6-qtbase, qt6-qtsvg, zlib"
