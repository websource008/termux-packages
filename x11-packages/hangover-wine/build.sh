...
TERMUX_PKG_DEPENDS="fontconfig, freetype, krb5, libc++, libgmp, libgnutls, libxcb, libxcomposite, libxcursor, libxfixes, libxrender, mesa, opengl, osmesa, pulseaudio, sdl2, vulkan-loader, xorg-xrandr"
