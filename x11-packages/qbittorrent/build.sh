...
TERMUX_PKG_SHA256=1c9695104e5bef7bcbe1fde2f141323acdf6d12669032e5a305517154fd03d49
TERMUX_PKG_FORCE_CMAKE=true
TERMUX_PKG_DEPENDS="libicu, libtorrent-rasterbar, openssl, qt5-qtbase"
TERMUX_PKG_BUILD_DEPENDS="qt5-qttools, qt5-qtsvg, boost, libc++, qt5-qttools-cross-tools"
