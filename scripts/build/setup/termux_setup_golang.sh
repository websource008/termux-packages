...
termux_setup_golang() {
	if [ "$TERMUX_ON_DEVICE_BUILD" = "false" ]; then
		local TERMUX_GO_VERSION=go1.22.4
		local TERMUX_GO_SHA256=ba79d4526102575196273416239cca418a651e049c2b099f3159db85e7bade7d
		if [ "$TERMUX_PKG_GO_USE_OLDER" = "true" ]; then
			TERMUX_GO_VERSION=go1.21.11
			TERMUX_GO_SHA256=54a87a9325155b98c85bc04dc50298ddd682489eb47f486f2e6cb0707554abf0
		fi
