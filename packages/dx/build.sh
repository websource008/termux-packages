...
TERMUX_PKG_SRCURL=https://github.com/termux/distfiles/releases/download/2021.01.04/dx-android-${TERMUX_PKG_VERSION}.jar
...
termux_step_make_install() {
	termux_download "$TERMUX_PKG_SRCURL" \
		"$TERMUX_PKG_CACHEDIR/dx-${TERMUX_PKG_VERSION}.jar" \
		"$TERMUX_PKG_SHA256"

	install -Dm600 "$TERMUX_PKG_CACHEDIR/dx-${TERMUX_PKG_VERSION}.jar" \
