...
termux_step_make_install() {
	...
	{
		echo "Components: tur tur-on-device tur-continuous"
		echo "Signed-By: $TERMUX_PREFIX/etc/apt/trusted.gpg.d/tur.gpg"
		echo "Suites: tur-packages"
		echo "Types: deb"
		echo "URIs: https://tur.kcubeterm.com"
