...
TERMUX_PKG_SRCURL=https://ftp.gnu.org/gnu/bash/bash-5.2.tar.gz
# https://mirrors.kernel.org/gnu/bash/bash-${_MAIN_VERSION}.tar.gz
TERMUX_PKG_SHA256=a139c166df7ff4471c5e0733051642ee5556c1cc8a4a78f145583c5c81ab32fb
TERMUX_PKG_AUTO_UPDATE=false
TERMUX_PKG_DEPENDS="readline (>= 8.0), termux-tools"
