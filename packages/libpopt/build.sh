...
# android-28 have iconv in libc, but we currently remove
# the iconv.h header file from the toolchain, letting
# it be provided by libiconv instead.
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="ac_cv_func_iconv=no"
