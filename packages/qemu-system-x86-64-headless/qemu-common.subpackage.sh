...
TERMUX_SUBPKG_BREAKS="qemu-system-x86-64 (<< 8.0.0), qemu-system-x86-64-headless (<< 8.0.0)"
TERMUX_SUBPKG_REPLACES="qemu-system-x86-64 (<< 8.0.0), qemu-system-x86-64-headless (<< 8.0.0)"
