...
TERMUX_PKG_VERSION=10.73.43
TERMUX_PKG_REVISION=3
TERMUX_PKG_SRCURL=https://downloads.sourceforge.net/project/netpbm/super_stable/${TERMUX_PKG_VERSION}/netpbm-${TERMUX_PKG_VERSION}.tgz
