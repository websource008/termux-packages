...
TERMUX_PKG_DEPENDS="libuv, luv, libmsgpack, libvterm (>= 0.3-0), libluajit, libunibilium, libtreesitter, lua51-lpeg, tree-sitter-lua, tree-sitter-query, tree-sitter-vimdoc"
