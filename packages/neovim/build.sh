...
TERMUX_PKG_SHA256=39fab47d241da7b9418823cc563c689d522c1c4b2def04036393834f3f1ca94c
TERMUX_PKG_AUTO_UPDATE=true
TERMUX_PKG_UPDATE_VERSION_REGEXP="^\d+\.\d+\.\d+$"
TERMUX_PKG_DEPENDS="libuv, luv, libmsgpack, libvterm (>= 0.3-0), libluajit, libunibilium, lua51-lpeg, tree-sitter, tree-sitter-parsers"
