...
TERMUX_PKG_DEPENDS="freetype, harfbuzz, harfbuzz-icu, libc++, libcairo, libgd, libgmp, libgraphite, libicu, liblua52, libmpfr, libpaper, libpixman, libpng, teckit, zlib, zziplib"
